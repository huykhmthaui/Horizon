            ...
            <DialogContent className="bg-white text-black dark:bg-[#313338] dark:text-white p-0 overflow-hidden">
                <DialogHeader className="pt-8 px-6">
                    ...
                    <DialogDescription className="text-center text-zinc-500 text-xl">
                        ...
                        <span className="font-semibold text-indigo-500 ml-1">{server?.name}</span>?<br />
                        <span className="font-semibold text-indigo-500 mr-1">{server?.name}</span> will be permanently deleted.
                    </DialogDescription>
                </DialogHeader>
